...
-- ---------------------------------------------------------------------------
-- Configuración del Promotion Cockpit (P40): todo editable desde la pantalla
-- ---------------------------------------------------------------------------
DROP TABLE IF EXISTS cockpit_tipos;
DROP TABLE IF EXISTS cockpit_canales;
DROP TABLE IF EXISTS cockpit_canal_reglas;
DROP TABLE IF EXISTS kpi_rubros;
DROP TABLE IF EXISTS kpi_metricas_def;
DROP TABLE IF EXISTS cockpit_parametros;
CREATE TABLE cockpit_tipos (
...
CREATE TABLE cockpit_canal_reglas (
  id     INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE cockpit_parametros (
  clave VARCHAR(40) NOT NULL,
  valor TEXT NULL,
  PRIMARY KEY (clave)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
