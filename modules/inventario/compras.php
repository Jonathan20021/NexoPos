...
<!-- Modal nueva compra -->
<div x-data="comprasForm()" @compra:new.window="reset(); open=true" @keydown.escape.window="open=false" x-show="open" x-transition.opacity style="display:none" class="fixed inset-0 bg-slate-900/40 z-50 flex items-start justify-center p-4 overflow-y-auto" @click.self="open=false">
  <div class="bg-white rounded-2xl shadow-pop w-full max-w-3xl my-8" @click.stop>
