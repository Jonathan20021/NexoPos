<?php
/**
 * Tabla 8 del catálogo oficial (LUG-OPE-MA-002 v4) — Provincias, Municipios y
 * Distritos Municipales de la República Dominicana.
 *
 * Se transcribe TAL CUAL del documento del proveedor, incluidas sus rarezas
 * (p. ej. 030001 aparece rotulado como municipio y 170300/251000 repiten el
 * nombre del distrito). Corregirlo por nuestra cuenta haría que enviáramos un
 * código que el validador del proveedor no reconoce.
 *
 * Lectura del código: PPMMDD → PP provincia, MM municipio, DD distrito.
 *   010000 = provincia · 010100 = municipio · 010101 = distrito municipal
 *
 * 582 códigos. Generado desde el PDF oficial; no editar a mano.
 */

/** [código => nombre] de los 582 códigos territoriales de la Tabla 8. */
function ecfTabla8(): array
{
    return [
